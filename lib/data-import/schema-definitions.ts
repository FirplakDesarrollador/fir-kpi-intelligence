...
// ---------------------------------------------------------------------------
// key   = exact Supabase column name used in the template header and insert.
// label = Spanish description shown in the Diccionario sheet (SAP origin).
// ---------------------------------------------------------------------------
const salesFactSchema: TableSchema = {
  ...
  fields: [
    { key: "document_type",           label: "Tipo Documento",                 type: "string",  required: false, example: "FV" },
    { key: "document_date",           label: "DOCDATE",                        type: "date",    required: true,  example: "2024-03-15" },
    { key: "document_number",         label: "DOCNUM",                         type: "string",  required: true,  example: "0090012345" },
    { key: "senior_seller",           label: "Vendedor Senior",                type: "string",  required: false, example: "María López" },
    { key: "junior_seller",           label: "Vendedor Junior",                type: "string",  required: false, example: "Carlos Ruiz" },
    { key: "sales_type",              label: "U_TipoVentas",                   type: "string",  required: false, example: "Directa" },
    ...
    { key: "customer_code",           label: "Cod Cliente",                    type: "string",  required: true,  example: "C001234" },
    { key: "customer_name",           label: "Nombre Cliente",                 type: "string",  required: true,  example: "Constructora Alfa S.A." },
    { key: "pos_code",                label: "Código Punto de Venta",          type: "string",  required: false, example: "PV-001" },
    { key: "pos_description",         label: "Descripción Punto de Venta",     type: "string",  required: false, example: "Tienda Norte" },
    { key: "cost_center",             label: "Centro de Costos",               type: "string",  required: false, example: "CC-01" },
    { key: "item_group",              label: "Grupo de Articulo",              type: "string",  required: false, example: "Paneles" },
    { key: "product_family",          label: "Familia",                        type: "string",  required: false, example: "Estructural" },
    { key: "item_code",               label: "Codigo Articulo",                type: "string",  required: true,  example: "FP-1200" },
    { key: "item_description",        label: "Descripcion de Articulo",        type: "string",  required: false, example: "Panel Firplak 12cm" },
    { key: "quantity",                label: "Cantidad",                       type: "number",  required: false, example: "250" },
    { key: "sale_price",              label: "Precio de venta",                type: "number",  required: false, example: "87500" },
    { key: "discount_percent",        label: "% Descuento",                    type: "number",  required: false, example: "6.29" },
    { key: "net_price",               label: "Precio tras el descuento",       type: "number",  required: false, example: "81931" },
    { key: "total_value",             label: "Valor Total",                    type: "number",  required: true,  example: "21875000" },
    { key: "unit_cost",               label: "Costo",                          type: "number",  required: false, example: "56000" },
    { key: "total_cost",              label: "Costo total",                    type: "number",  required: false, example: "14000000" },
    { key: "gross_profit",            label: "Utilidad Bruta",                 type: "number",  required: false, example: "7875000" },
    { key: "gross_margin",            label: "Margen Bruta",                   type: "number",  required: false, example: "36.00" },
    { key: "project_name",            label: "Obra",                           type: "string",  required: false, example: "Edificio Central" },
    { key: "city",                    label: "Ciudad",                         type: "string",  required: false, example: "Bogotá" },
    { key: "phone",                   label: "Teléfono",                       type: "string",  required: false, example: "3001234567" },
    { key: "novelty_end_date",        label: "Fecha Fin Novedad",              type: "date",    required: false, example: "2024-04-01" },
    { key: "customer_segment",        label: "Segmento del cliente",           type: "string",  required: false, example: "Premium" },
    { key: "credit_note_type_code",   label: "Codigo del Tipo NC",             type: "string",  required: false, example: "NC-01" },
    { key: "credit_note_type",        label: "TiposNC",                        type: "string",  required: false, example: "Devolución" },
    { key: "credit_note_concept_code",label: "Codigo Concepto Nc",             type: "string",  required: false, example: "CC-05" },
    { key: "credit_note_concept",     label: "Conceptos Notas Crédito",        type: "string",  required: false, example: "Avería en transporte" },
    { key: "comments",                label: "COMMENTS",                       type: "string",  required: false, example: "" },
    { key: "source_query",            label: "Query origen",                   type: "string",  required: false, example: "SAP_ventas_v2" },
  ],
}
